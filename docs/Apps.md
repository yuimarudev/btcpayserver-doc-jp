...
**Point of Sale アプリ** は、設定やカスタマイズ次第で、寄付・チップの受け取りや小規模 EC ショップとしても利用できます。

現在、**Point of Sale アプリ** は次の 3 つの表示モードに対応しています。
...
最初の **Point of Sale アプリ** を動かすには、以下の手順に従ってください。
...
**Point of Sale アプリ** の見た目は、[テーマカスタマイズガイド](./Development/Theme.md) に従って変更できます。
